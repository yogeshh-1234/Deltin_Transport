...
import { CalenderIcon, HeaderUserIcon } from '../../assets/icons/Icon';
    ...
    return (
        <header className={`z-40 ${themeConfig.semidark && themeConfig.menu === 'horizontal' ? 'dark' : ''}`}>
            <div className="shadow-sm">
                <div className="bg-white flex w-full items-center px-5 py-2.5 dark:bg-black ">
                    <div className="sm:flex-1 ltr:sm:ml-0 ltr:ml-auto sm:rtl:mr-0 rtl:mr-auto flex items-center space-x-1.5 lg:space-x-2 rtl:space-x-reverse dark:text-[#d0d2d6]">
                        <div className="sm:ltr:mr-auto sm:rtl:ml-auto ">
                            ...
                            >
                                <div>
                                    <input
                                        type="text"
                                        className="form-input ltr:pl-9 rtl:pr-9 ltr:sm:pr-4 rtl:sm:pl-4 ltr:pr-9 rtl:pl-9 
                                        peer sm:bg-transparent bg-gray-100 placeholder:tracking-widest 
                                        w-[450px]"
                                        placeholder="Search..."
                                    />
                        ...
                        <div className="bg-white">
                            <div className="flex items-center gap-3 justify-between">
                                {/* Date/Time Section */}
                                <div className="flex items-center gap-2 bg-[#FFF2CB]  rounded-lg px-3 py-2">
                                    <CalenderIcon height={18} width={18} />
                                    <span className="text-sm font-medium text-gray-900">25/08/2025 12:05:15</span>
                                </div>
                                <div className="dropdown shrink-0">
                                    <Dropdown
                                        offset={[0, 8]}
                                ...
                                <div className="flex items-center gap-3">
                                    <HeaderUserIcon height={32} width={32} />
                                    <div>
                                        <p className="text-sm font-bold font-medium text-gray-900">VERNON FERNANDES</p>
                                        <p className="text-xs text-[#343A40]">User ID: DR12345</p>
                                    </div>
                                </div>
                            </div>
                        </div>
