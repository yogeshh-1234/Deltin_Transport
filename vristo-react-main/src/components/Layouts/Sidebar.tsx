                ...
                <div className="bg-white dark:bg-black h-full">
                    <div className="flex justify-between items-center px-4 py-3">
                        <NavLink to="/" className="main-logo flex items-center shrink-0">
                            <img className="w-8 ml-[5px] flex-none" src="../../assets/images/DeltinLogo.png" alt="logo" />
                    ...
                    <PerfectScrollbar className="h-[calc(100vh-80px)] relative">
                        <ul className="relative font-semibold space-y-0.5 p-4 py-0">
                            ...
                            <h2 className="py-3 px-7 flex items-center uppercase font-extrabold bg-[#D9A404] text-white rounded-lg mx-1 my-1">
                                <IconMinus className="w-4 h-5 flex-none hidden" />
                                <span>{t('Fleet Transport')}</span>
                            </h2>
                            ...
                            <li className="nav-item">
                                <ul className="space-y-3">
                                    ...
                                    <li className="nav-item">
                                        <NavLink to="/fleet/trip" className="group">
                                            <div className="flex items-center">
                                    ...
                                    <li className="nav-item">
                                        <NavLink to="/fleet/driver" className="group">
                                            <div className="flex items-center">
                                    ...
                                    <li className="nav-item">
                                        <NavLink to="/fleet/vehicle" className="group">
                                            <div className="flex items-center">
                                    ...
                                    <li className="nav-item">
                                        <NavLink to="/fleet/report" className="group">
                                            <div className="flex items-center">
                                    ...
                                    <li className="nav-item">
                                        <NavLink to="/fleet/setting" className="group">
                                            <div className="flex items-center">
                                    ...
                                    <li className="nav-item">
                                        <NavLink to="/fleet/request" className="group">
                                            <div className="flex items-center">
                                                <IconMenuContacts className="group-hover:!text-primary shrink-0" />
                                ...
                                <ul className="space-y-3">
                                    ...
                                    <li className="nav-item">
                                        <NavLink to="/apps/todolist" className="group">
                                            <div className="flex items-center">
                                                <IconMenuTodo className="group-hover:!text-primary shrink-0" />
                                                <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('Routes')}</span>
                                            </div>
                                        </NavLink>
                                    </li>
                                    <li className="nav-item">
